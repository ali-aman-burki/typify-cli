...
from typify_prototype.inferencing.function_utils import FunctionUtils
from typify_prototype.preprocessing.dependency_utils import DependencyUtils
from typify_prototype.inferencing.mro import MROBuilder
from typify_prototype.inferencing.resolver import Resolver
...
from typify_prototype.utils.errors import safeguard
from typify_prototype.inferencing.annotation_utils import (
	DeferredAnnotations,
	Varnotation,
	AnnotationUtils
)
from typify_prototype.inferencing.expression import (
    TypeExpr, 
    AliasParser
)
from typify_prototype.inferencing.commons import (
	Builtins,
	Future,
	Singletons,
	ArgTuple,
...
from typify_prototype.preprocessing.instance_utils import (
	Instance,
	ReferenceSet,
	VSlot
)
...
class Executor(ast.NodeVisitor):
	def __init__(
		...
		from typify_prototype.inferencing.generics.utils import GenericUtils
	...
	def visit_FunctionDef(self, func_tree: Union[ast.FunctionDef, ast.AsyncFunctionDef]):
		from typify_prototype.preprocessing.instance_utils import FSlot
		...
		param_names = PreCollector.collect_parameter_slots(func_tree)
	...
	def visit_AugAssign(self, node):
		from typify_prototype.inferencing.desugar import Desugar
		from typify_prototype.inferencing.call_dispatcher import CallDispatcher
