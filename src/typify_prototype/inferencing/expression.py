...
from typify_prototype.preprocessing.instance_utils import Instance, ReferenceSet

from typify_prototype.preprocessing.symbol_table import ClassDefinition
...
class PackedExpr:
	...
	def __repr__(self):
		...
		fqn = prefix if prefix else "<unvisited>"
		strs = []
...
class TypeExpr:
	...
	def __repr__(self):
		fqn = self.base.parent.id if self.base else "<unvisited>"
...
class AliasParser:
	...
	def filter_concsubs(concsubs: dict):
		from typify_prototype.inferencing.generics.model import Placeholder
