...
class Desugar:
	...
	def resolve(node: ast.expr, resolver: Resolver):
		...
		from typify_prototype.inferencing.expression import AliasParser, TypeExpr, PackedExpr
		from typify_prototype.inferencing.commons import Checker, Typing, Types
